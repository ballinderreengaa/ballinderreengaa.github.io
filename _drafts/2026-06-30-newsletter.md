<article>
    ...
    <section id="sea-to-summit-training-program">
        ...
        <p>Keith Carr intends to run a 12 week training program to prepare for the Westport Sea to Summit&nbsp;
            Spirit
            event which takes place on Saturday, November 7th. The Spirit event consists of&nbsp;</p>
        <p></p>
        <ul style="text-align: left;">
            <li>⁠4k run</li>
            <li>8k cycle</li>
            <li>4k Mountain run (Croagh Patrick)</li>
            <li>11k cycle</li>
            <li>4k run</li>
        </ul>
        <p></p>
        <p>The training program will begin in August. All fitness levels are welcome</p>
        <p>The cost is €200 (which includes the face fee and accommodation for Friday night) or €280 (which includes
            the
